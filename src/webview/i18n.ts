...
const english: WebviewStrings = {
  relationGraph: 'Git Relations', commitGraph: 'Commit history', commitGraphUnavailable: 'Commit history is unavailable. Refresh the viewer and try again.', refresh: 'Refresh', tags: 'Tags', remoteBranches: 'Remote branches', hideDetails: 'Hide details', showDetails: 'Show details', resizeDetails: 'Resize details pane',
...
const japanese: WebviewStrings = {
  relationGraph: 'Git 関係図', commitGraph: 'コミット履歴', commitGraphUnavailable: 'コミット履歴を読み込めません。ビューアーを更新してからもう一度試してください。', refresh: '更新', tags: 'タグ', remoteBranches: 'リモートブランチ', hideDetails: '詳細を隠す', showDetails: '詳細を表示', resizeDetails: '詳細ペインの幅を変更',
