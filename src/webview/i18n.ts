export interface WebviewStrings {
  ...
  commitGraph: string; nodesAndRefs(nodes: number, refs: number): string; commitsAndRefs(commits: number, refs: number): string; readingRelations: string; zoomControls: string; zoomOut: string; resetZoom: string; zoomIn: string; branchAriaLabel(name: string): string; selectionHint: string;
...
const english: WebviewStrings = {
  relationGraph: 'Git Relations', commitGraph: 'Commit history', refresh: 'Refresh', tags: 'Tags', remoteBranches: 'Remote branches', hideDetails: 'Hide details', showDetails: 'Show details', resizeDetails: 'Resize details pane',
...
const japanese: WebviewStrings = {
  relationGraph: 'Git 関係図', commitGraph: 'コミット履歴', refresh: '更新', tags: 'タグ', remoteBranches: 'リモートブランチ', hideDetails: '詳細を隠す', showDetails: '詳細を表示', resizeDetails: '詳細ペインの幅を変更',
