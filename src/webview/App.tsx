...
export function App() {
  ...
  const visibleGraph = viewMode === 'relations' ? data?.graph : viewMode === 'significant' ? showAllCommits ? data?.commitGraph : summarizeCommits ? data?.significantGraph : data?.minimalGraph : data?.commitGraph;
